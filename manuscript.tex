...
\begin{figure}[ht!]
	\begin{center}
        ...
        \caption{a) Thermo value calculated from Santalucia data and from MSMs b) TICA projections of freen energies and state clustering c) and transitions probabilities between states \textcolor{magenta}{Consider getting rid of enthalpy and entropy columns (can add to SI). Need to add State numbers next to names}}
...
\subsection{Project results onto shared basis}
...
\subsection{Will look a lot like the last paragraph of the intro / the abstract}
