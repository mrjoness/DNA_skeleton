...
\textbf{Author Reply:} The designation and structural representation of the macrostates is critical to the conclusions of the manuscript and we concur that we should better expose for the reader how the representative microstates were selected, how representative they are of the microstate ensemble within the macrostate, and our analysis of the base-pairing patterns within each macrostate that motivated our naming scheme. We have addressed this by modifying the main text and conducting additional analyses of our microstate and macrostate distributions that we detail in a new figure in the Supporting Information.
